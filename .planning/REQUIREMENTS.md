...
- [x] **INF-03**: Example app in `example/` demonstrating all three tiers
- [x] **INF-04**: Unit tests for all token values, extension methods, theme resolution
- [x] **INF-05**: Golden tests for styled widgets across light/dark themes (using Ahem font for CI stability)
...
- [x] **INF-10**: Dartdoc coverage ≥ 80% on all public APIs
